...
const seed = async () => {
  try {
    ...
    const services = [
      ...
      { id: 'service-5', sitter_id: 'sitter-id-4', title: 'Enfermería infantil y primeros auxilios', description: 'Cuidadora certificada en enfermería, ideal para niños que requieran administración de medicamentos o cuidados especiales.', category: 'Cuidado Especial / Estimulación', hourly_rate: 30, status: 'approved', created_at: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString() },
      { id: 'service-6', sitter_id: 'sitter-id-5', title: 'Cuidado integral de infantes y lectura de cuentos', description: 'Acompañamiento, narración de historias divertidas, actividades didácticas y preparación de meriendas nutritivas.', category: 'Cuidado General / Juegos', hourly_rate: 20, status: 'approved', created_at: now }
    ];
